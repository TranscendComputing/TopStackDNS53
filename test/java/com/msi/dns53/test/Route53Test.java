...
public class Route53Test {
    public static void main(String args[]) throws SAXException, IOException {
        ...
        /*
         * try{ ListResourceRecordSets(client); }catch(Exception e){
        ...
        /*
         * com.amazonaws.transform.StaxUnmarshallerContext context = new
         * StaxUnmarshallerContext(null); context.getHeader("Location");
         */
    ...
    public static void testReflection() {
        ...
        try {
            ...
            c = (Constructor<AmazonServiceException>) clazz
                    .getConstructor(String.class);
            exception = (AmazonServiceException) c
                    .newInstance(new String[] { "Whatever" });
        } catch (Exception e) {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (line != null && !line.equals("")) {
                        ...
                        // Process restart = new ProcessBuilder("/bin/bash",
                        // "-c", restartCmd).start();
                    }
